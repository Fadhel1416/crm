...
include('app/commun.inc.php');
include('app/config.inc.php');
include('app/components/uncludes/header.php');
...
?>
	...
	<header class="main-header" id="headerid">
		<div class="d-flex align-items-center logo-box justify-content-center" >	
			<!-- Logo -->
			<a href="https://desk.hosteur.pro/index.php?page=dashboard" class="logo">
			<!-- logo-->
			...
			<div class="logo-lg">
				<span class="light-logo"><b>Desk Hosteur</b></span>
				...
				<li class="btn-group d-lg-inline-flex d-none">
					...
					<div class="app-menu">
						<div class="search-bx ">
							<form>
								<div class="input-group">
                    <input type="search" class="form-ontrol" placeholder="Chercher...."  id="chercherFields" onfocus="GetFields();">
					<div class="input-group-append">
									<button class="btn" type="submit" id="button-addon4"><i data-feather="search"></i></button>
...
<div class="navbar-custom-menu r-side">
	...
	<li class="dropdown notifications-menu" id="notifications">
		<a href="#" id="functionnoti"  class="dropdown-toggle btn-outline no-border  text-white"  data-bs-toggle="dropdown">
		...
		<li class="header">
            ...
            <ul class="dropdown-menu animated flipInX">
				<li class="user-body">
					...
					<a class="dropdown-item" href="?page=logout"><i class="ti-lock text-muted me-2"></i> Logout</a>
				</li>
				</ul>
			</li>			  
    ...
    <section class="sidebar position-relative">	
			...
			<div class="multinav-scroll" style="height: 100%;">	
				...
				<li class="header">Companies & Configuration </li>
			...
			<li class="treeview"  id="user">
				...
				<div class="copyright text-start m-25">
					<p style="bottom: 0;"><strong class="d-block">Desk Hosteur Dashboard</strong> © <?php echo date('Y');?> All Rights Reserved</p>
					</div>
				</div>
			</div>
			</div>
	...
	<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" id="modal-ForFields"  >
		<div class="modal-dialog modal-lg">
			<div class="modal-content bg-lightest"  style="border-radius:1rem;border:1px solid #e9e9f2;">
				<div class="modal-header"  style=" border-top-left-radius: calc(1rem - 1px);border-top-right-radius: calc(1rem - 1px);">
					<h4 class="modal-title text-info" id="myLargeModalLabel">Checher</h4>
				...
				<li><a href="#leads" data-bs-toggle="tab" class="active">Leads</a></li>

					<li><a href="#tickets" data-bs-toggle="tab">Tickets</a></li>
                ...
                <div class="tab-pane active" id="leads">
                 <form action="">
					 <div class="input-group">
					 <input type="text" class="form-control bg-white" placeholder="Rechercher des leads" id="input-search3" onClick="FunctionVerifInput(3);" onkeyup="FindLeadModal(3);" >
					 <span class="input-group-text border-0" id="search-addon">
					<i class="fas fa-search"></i>
				</span>
					</div>
					<div class="user-list3" id="user-list3">
				 ...
				 <form action="">
					 <div class="input-group">
					 <input type="text" class="form-control" placeholder="Rechercher des Tickets" id="input-search4" onClick="FunctionVerifInput(4);" onkeyup="FindTicketModal(4);">
					 <span class="input-group-text border-0" id="search-addon">
						<i class="fas fa-search"></i>
					</span>

					</div>
					<div class="user-list3" id="user-list4">
					<div class="box  no-shadow">
...
include('app/components/uncludes/footer.php');
...
$('#input-search2').focus(function(event){
	...
	let pk_user=document.getElementById('pk_user').value;
	let xhr3 = new XMLHttpRequest();
	xhr3.open("POST", "app/components/pages/IndexFindLead.php", true);
	xhr3.onload = ()=>{
	...
	function Mark_Notification_As_Seen(){
	  ...
	  function FunctionVerifInput(id)
		{
		const searchBar =document.getElementById('input-search'+id);
		if(searchBar=="")
		{
			var usersList = document.getElementById('user-list'+id);
			userslist.innerHTML="";
		}
		...
		dataleadfind["pk_user"]=pk_user;
		//dataleadfind["idcomp"]=idcamp;
		console.log(dataleadfind["pk_user"]);
		xhr3.send("searchTermtab=" + JSON.stringify(dataleadfind));
		}

}
function FindTicketModal(id){
		const searchBar =document.getElementById('input-search'+id);
		var usersList = document.getElementById('user-list'+id);
		//var idcamp=document.getElementById('campidhidden').value;
		// var menu = document.getElementById('idmenu');
		...
		let xhr3 = new XMLHttpRequest();
		xhr3.open("POST", "app/components/pages/IndexFindTicketModal.php", true);
		xhr3.onload = ()=>{
		if(xhr3.readyState === XMLHttpRequest.DONE){
			if(xhr3.status === 200){
			let data = xhr3.response;
			var ss='<div class="box" style="margin-bottom:0px"><div class="box-body p-0" ><div class="bg-white text-center rounded  b-1"><h5>Aucun reclamations n’est disponible</h5></div></div></div>';
			if(data != ss){
			usersList.innerHTML = data;
		...
		xhr3.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
		dataticketfind["searchTerm"]=searchTerm;
		dataticketfind["pk_user"]=pk_user;
		//dataleadfind["idcomp"]=idcamp;
		console.log(dataticketfind["pk_user"]);
		xhr3.send("searchTermtab=" + JSON.stringify(dataticketfind));
		}

}
function FindLeadModal(id){
		const searchBar =document.getElementById('input-search'+id);
		var usersList = document.getElementById('user-list'+id);
		//var idcamp=document.getElementById('campidhidden').value;
		// var menu = document.getElementById('idmenu');
		...
		let xhr3 = new XMLHttpRequest();
		xhr3.open("POST", "app/components/pages/IndexFindLeadModal.php", true);
		xhr3.onload = ()=>{
		if(xhr3.readyState === XMLHttpRequest.DONE){
			if(xhr3.status === 200){
			let data = xhr3.response;
		...
		"language": {
				"sProcessing": "Traitement en cours ...",
				"sLengthMenu": "Afficher _MENU_ Leads archivés",
				"sZeroRecords": "Aucun lead trouvé",
				"sEmptyTable": "Aucune donnée disponible",
				"sInfo": "_START_ à _END_ sur _TOTAL_ Leads archivés",
				"sInfoEmpty": "Aucune ligne affichée",
				"sInfoFiltered": "(Filtrer un maximum de _MAX_)",
				"sInfoPostFix": "",
				"sSearch": "Chercher:",
		...
		"language": {
				"sProcessing": "Traitement en cours ...",
				"sLengthMenu": "Afficher _MENU_ Nouvelle Leads",
				"sZeroRecords": "Aucun lead trouvé",
				"sEmptyTable": "Aucune donnée disponible",
				"sInfo": "_START_ à _END_ sur _TOTAL_ Nouvelle Leads",
				"sInfoEmpty": "Aucune ligne affichée",
				"sInfoFiltered": "(Filtrer un maximum de _MAX_)",
				"sInfoPostFix": "",
				"sSearch": "Chercher:",
		...
		"language": {
				"sProcessing": "Traitement en cours ...",
				"sLengthMenu": "Afficher _MENU_ Leads en cours",
				"sZeroRecords": "Aucun lead trouvé",
				"sEmptyTable": "Aucune donnée disponible",
				"sInfo": "_START_ à _END_ sur _TOTAL_ Leads en cours",
				"sInfoEmpty": "Aucune ligne affichée",
				"sInfoFiltered": "(Filtrer un maximum de _MAX_)",
				"sInfoPostFix": "",
				"sSearch": "Chercher:",
		...
		"language": {
				"sProcessing": "Traitement en cours ...",
				"sLengthMenu": "Afficher _MENU_ Leads traités",
				"sZeroRecords": "Aucun lead trouvé",
				"sEmptyTable": "Aucune donnée disponible",
				"sInfo": "_START_ à _END_ sur _TOTAL_ Leads traités",
				"sInfoEmpty": "Aucune ligne affichée",
				"sInfoFiltered": "(Filtrer un maximum de _MAX_)",
				"sInfoPostFix": "",
				"sSearch": "Chercher:",
		...
		"language": {
				"sProcessing": "Traitement en cours ...",
				"sLengthMenu": "Afficher _MENU_ Leads convertis",
				"sZeroRecords": "Aucun lead trouvé",
				"sEmptyTable": "Aucune donnée disponible",
				"sInfo": "_START_ à _END_ sur _TOTAL_ Leads convertis",
				"sInfoEmpty": "Aucune ligne affichée",
				"sInfoFiltered": "(Filtrer un maximum de _MAX_)",
				"sInfoPostFix": "",
				"sSearch": "Chercher:",
    ...
    "use strict";   
		...
		$('#user-list3').slimScroll({
            height: '500px'
        });
        $('#user-list4').slimScroll({
            height: '500px'
        });
