...
if($_POST)
{
	...
	$POSTVALUE1 = "fct=UserAdd&S_NAME=".$S_NAME."&S_TEL=".$S_TEL."&S_IP=".$S_IP."&email=".$email."&password=".$password;
	$res1 = curl_do_post($URL1, $POSTVALUE1);

	/*$URLP  = "https://www.yestravaux.com/webservice/email/";
	$POSTVALUE = "fct=EmailSendTpl&CUSTOMER_PHONE_NUMBER=0101010101&tpl=user-register&PK_USER=".$res1->PK_USER."&K_KEY=".$res1->K_KEY;
	$ress = curl_do_post($URLP,$POSTVALUE);*/
	var_dump($res1);
	if($res1==1)
	{
...
<head>
  <meta charset="utf-8">
    ...
    <title>Desk Hosteur - Inscription </title>
...
<body class="hold-transition theme-fruit bg-img" style="background-image: url(../../../images/auth-bg/bg-2.jpg)">
				...
				<div class="row justify-content-center g-0">
					<div class="col-lg-5 col-md-5 col-12">
						<div class="bg-white rounded10 shadow-lg">
							...
							<div class="p-40">
								<form onsubmit="return verifFields()" action="auth_register.php" method="post" id="formreg" >
	...
	<script>
    //filtrer function for email validations..................
  ...
  return re.test(email.toLowerCase().trim());
   ...
   phoneInputField.addEventListener("countrychange", function(e) {
	...
	function verifFields()
	{
		...
		/*List=document.querySelector(".iti__active").children;
		tt=List[2].innerHTML;
        console.log(tt);
		$('#Code').val(tt);*/
		return true;	
