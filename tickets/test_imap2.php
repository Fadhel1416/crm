...
<body>
    ...
    <div id="dataDivID" class="form-container" style="display:none;">
        <?php
            ...
            //     $POSTVALUE  = 'fct=CreateTicketFromEmail&user_id=12&email='.$email.'&subject='.htmlspecialchars($subject).'&body='.htmlspecialchars($body).
            //     '&nomPrenom='.$nom_prenom.'&date='.$date;
            //     $Result=curl_do_post($URL,$POSTVALUE);
            //     $Result=json_decode($Result);
            // }
            // $host = '{imap.gmail.com:993/imap/ssl}INBOX';//input stream  with imap protocale............
            // /* Your gmail credentials */
            // $user = 'alifadhel619@gmail.com';
            // $password = 'fadhel1416$';
            ...
            // $mails = imap_search($conn, 'ON "'.date('y-m-d').'"');//recuperer les emails arriver dans le date currant.....................
            ...
            // $mailOutput = '';
            // $mailOutput.= '<table class="table"><tr><th>Subject</th><th>Sender Name</th>
            //            <th> Content </th></tr>';
            ...
            //     }
            //     }
            //     $finalMessage =utf8_decode(imap_qprint($finalMessage));
            ...
            //     $mailOutput.= '<td><span class="columnClass"><form><input type="checkbox"/></form>' .
